...
void MX_LoRaWAN_Init(void)
{
  ...
  GNSE_BSP_LED_On(LED_GREEN); // turn ON
  LoRaWAN_Init();
  GNSE_BSP_LED_Off(LED_GREEN); // turn OFF
...
int main(void)
{
  ...
  {
    MX_LoRaWAN_Process();
    GNSE_BSP_LED_Toggle(LED_RED);  // RED indicates the superloop, blue indicates LoRaWAN TXs.
  }
}
